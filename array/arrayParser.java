...
public class arrayParser extends Parser {
	...
	public static class Vec4Context extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof arrayListener ) ((arrayListener)listener).enterVec4(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof arrayListener ) ((arrayListener)listener).exitVec4(this);
		}
	}
	...
	public static class IntsContext extends ParserRuleContext {
		public int max;
		public int i = 1;
		public List<TerminalNode> INT() { return getTokens(arrayParser.INT); }
		public TerminalNode INT(int i) {
			return getToken(arrayParser.INT, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof arrayListener ) ((arrayListener)listener).enterInts(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof arrayListener ) ((arrayListener)listener).exitInts(this);
		}
	}
